(() => {
  ...
  function G(e) {
    ...
    u && c.target && c.target.shadowRoot && h && (p = v(h[0]));
    ...
    ie(),
      document.querySelector(".about__slider") &&
        new te(".about__slider", {
          ...
          loop: !0,
          navigation: {
            nextEl: ".about__arrow_left",
            prevEl: ".about__arrow_right",
          },
          breakpoints: {
  ...
  const re = document.querySelectorAll("._anim-items");
  if (re.length > 0) {
    function ae(e) {
      for (let e = 0; e < re.length; e++) {
        const t = re[e],
          ...
          i = oe(t).top,
          n = 4;
        let r = window.innerHeight - s / n;
        s > window.innerHeight &&
          (r = window.innerHeight - window.innerHeight / n),
          pageYOffset > i - r && pageYOffset < i + s
